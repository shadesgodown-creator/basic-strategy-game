# Much of the code in this script was taken from gdquest.com
...
# Returns the position of a cell's center in pixles.
...
# cell's center.
func calculate_grid_coordinated(map_position: Vector2)-> Vector2:
